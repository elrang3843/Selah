...
4. [파일 메뉴](#4-파일-메뉴)
5. [편집 메뉴](#5-편집-메뉴)
6. [오디오 가져오기](#6-오디오-가져오기)
7. [클립 편집](#7-클립-편집)
8. [MR(반주) 추출 — 스템 분리](#8-mr반주-추출--스템-분리)
9. [악보 인식으로 트랙 추가](#9-악보-인식으로-트랙-추가)
10. [내보내기](#10-내보내기)
...
![시작 화면](screenshots/01_welcome.png)
...
![새 프로젝트 대화상자](screenshots/02_new_project.png)
...
![메인 편집 화면](screenshots/03_editor.png)
...
![파일 메뉴](screenshots/04_menu_file.png)
...
![편집 메뉴](screenshots/05_menu_edit.png)
...
3. 인식이 완료되면 악기 선택 화면이 나타납니다.
4. 원하는 악기를 선택하고 **삽입**을 클릭합니다.
